...
(function ($) {
    ...
    ATL_JQ.IssueDialog = function (options) {
        ...
        if (!options.baseUrl) {
            options.baseUrl = "https://jira.24x7th.com"
        }
        ...
        if (this.options.triggerPosition === "CUSTOM") {
            ...
            $(function () {
                try {
                    ...
                    if (window.ATL_JQ_PAGE_PROPS && ((window.ATL_JQ_PAGE_PROPS.triggerFunction) || (window.ATL_JQ_PAGE_PROPS["25d0e0ca"] && window.ATL_JQ_PAGE_PROPS["25d0e0ca"].triggerFunction))) {
                        newTriggerFunction = window.ATL_JQ_PAGE_PROPS.triggerFunction || window.ATL_JQ_PAGE_PROPS["25d0e0ca"].triggerFunction
                    } else {
    ...
    ATL_JQ.IssueDialog.prototype = {
        ...
        show: function () {
            var that = this,
                ...
                loadingText = "Issue collector is loading",
            ...
            dummyElement.href = "https://jira.24x7th.com";
    ...
    ATL_JQ(function () {
        if ("25d0e0ca" == "" && typeof ATL_JQ_CONFIGS == "undefined") {
            return
        }
        ...
        if (typeof ATL_JQ_CONFIGS != "undefined") {
            ...
            var baseUrl = "https://jira.24x7th.com";
            $.ajax({
                url: baseUrl + "/rest/collectors/1.0/configuration/trigger/25d0e0ca?os_authType=none",
                dataType: "jsonp",
                crossDomain: true,
                jsonpCallback: "trigger_25d0e0ca",
                cache: true,
                success: function (result) {
                    showTrigger(result, "25d0e0ca")
                }
            })
        }
    });
